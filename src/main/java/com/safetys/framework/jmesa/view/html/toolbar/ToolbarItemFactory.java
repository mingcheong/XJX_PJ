...
import static com.safetys.framework.jmesa.view.html.HtmlConstants.*;
...
public class ToolbarItemFactory {
	...
	protected String getExportImage(ToolbarExport export) {
		...
		if (StringUtils.isNotBlank(image)) { return image; }
	...
	protected String getExportTooltip(ToolbarExport export) {
		...
		if (StringUtils.isNotBlank(tooltip)) { return tooltip; }
