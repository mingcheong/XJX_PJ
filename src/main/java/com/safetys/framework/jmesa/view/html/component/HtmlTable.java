 ...
 * the License.
 */
package com.safetys.framework.jmesa.view.html.component;
...
public class HtmlTable extends Table {
	...
	public String getTheme() {
		if (StringUtils.isBlank(theme)) { return getCoreContext().getPreference(HtmlConstants.TABLE_COMPONENT_THEME); }
	...
	public String getStyleClass() {
		if (StringUtils.isBlank(styleClass)) { return getCoreContext().getPreference(HtmlConstants.TABLE_RENDERER_STYLE_CLASS); }
	...
	public String getBorder() {
		if (StringUtils.isBlank(border)) { return "0"; }
	...
	public String getCellpadding() {
		if (StringUtils.isBlank(cellpadding)) { return "0"; }
	...
	public String getCellspacing() {
		if (StringUtils.isBlank(cellspacing)) { return "0"; }
