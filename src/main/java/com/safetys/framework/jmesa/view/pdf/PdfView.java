 ...
 * the License.
 */
package com.safetys.framework.jmesa.view.pdf;
...
import com.safetys.framework.jmesa.view.html.HtmlSnippetsImpl;
...
public class PdfView extends AbstractExportView {
	...
	private static class EscapeXmlCellEditor implements CellEditor {
		...
		public Object getValue(Object item, String property, int rowcount) {
			...
			if (value != null) { return StringEscapeUtils.escapeXml(value.toString()); }
