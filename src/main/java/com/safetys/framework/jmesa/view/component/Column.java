 ...
 * the License.
 */
package com.safetys.framework.jmesa.view.component;
...
import com.safetys.framework.jmesa.view.renderer.BasicCellRenderer;
...
public class Column extends AbstractContextSupport {
	...
	public String getTitle() {
		if (titleKey != null) { return getCoreContext().getMessage(titleKey); }

		if (StringUtils.isBlank(title)) { return ViewUtils.camelCaseToWord(property); }
	...
	public void setCellEditor(CellEditor cellEditor) {
		...
		/*
		 * This is useful for editors that are decorated at runtime. Most of the
		 * support classes are handled in the TableFacadeUtils.init() method
		 * though.
		 */
