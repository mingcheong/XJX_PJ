...
import static com.safetys.framework.jmesa.view.html.HtmlConstants.TOOLBAR_MAX_ROWS_DROPLIST_INCREMENTS;
...
public class MaxRowsItemRenderer extends AbstractItemRenderer {
	...
	public String render() {
		...
		if (!incrementsContainsMaxRows(item, maxRows)) { throw new IllegalStateException("The maxRowIncrements does not contain the maxRows."); }
