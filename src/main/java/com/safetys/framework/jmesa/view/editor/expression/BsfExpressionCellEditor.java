 ...
 */
package com.safetys.framework.jmesa.view.editor.expression;

import static com.safetys.framework.jmesa.util.AssertUtils.notNull;
import com.safetys.framework.jmesa.view.editor.*;
...
public class BsfExpressionCellEditor extends AbstractCellEditor {
    ...
    protected BSFManager getBsfManager() {
        ...
        BSFManager manager = (BSFManager) ctx.getAttribute("com.safetys.framework.jmesa.BSFManager");
        if (manager == null) {
            manager = new BSFManager();
            ctx.setAttribute("com.safetys.framework.jmesa.BSFManager", manager);
        }
        return manager;
    }
}
