 ...
 * the License.
 */
package com.safetys.framework.jmesa.limit;
...
public class Limit implements Serializable {
	private static final long serialVersionUID = 8887238549509779067L;
	...
	public RowSelect getRowSelect() {
		if (rowSelect == null) { throw new IllegalStateException("The RowSelect object is null. You need to set a valid RowSelect on the Limit."); }
