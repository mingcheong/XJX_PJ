 ...
 * the License.
 */
package com.safetys.framework.jmesa.util;

import com.safetys.framework.jmesa.core.CoreContext;
import com.safetys.framework.jmesa.core.CoreContextSupport;
import com.safetys.framework.jmesa.core.IdSupport;
import com.safetys.framework.jmesa.core.filter.FilterMatcherRegistry;
import com.safetys.framework.jmesa.core.filter.FilterMatcherRegistrySupport;
import com.safetys.framework.jmesa.core.message.Messages;
import com.safetys.framework.jmesa.core.message.MessagesSupport;
import com.safetys.framework.jmesa.limit.ExportType;
import com.safetys.framework.jmesa.limit.state.StateAttrSupport;
import com.safetys.framework.jmesa.view.ExportTypesSupport;
import com.safetys.framework.jmesa.view.component.Column;
import com.safetys.framework.jmesa.view.component.ColumnSupport;
import com.safetys.framework.jmesa.view.component.Row;
import com.safetys.framework.jmesa.view.component.RowSupport;
import com.safetys.framework.jmesa.view.component.Table;
import com.safetys.framework.jmesa.view.component.TableSupport;
import com.safetys.framework.jmesa.view.editor.PatternSupport;
import com.safetys.framework.jmesa.view.html.toolbar.MaxRowsIncrementsSupport;
import com.safetys.framework.jmesa.view.html.toolbar.Toolbar;
import com.safetys.framework.jmesa.view.html.toolbar.ToolbarSupport;
import com.safetys.framework.jmesa.web.WebContext;
import com.safetys.framework.jmesa.web.WebContextSupport;

/**
 * Utility to first check to see if the object being inspected is an instance of
 * the support class. If it is then will do a check to see if the object to be
 * injected is already set. If it is not then it will be injected.
 * 
 * @since 2.2
...
public class SupportUtils {
	...
	/**
	 * Set the WebContext on the object being inspected if it is not already
	 * set.
	 * 
	 * @param obj
	...
	/**
	 * Set the CoreContext on the object being inspected if it is not already
	 * set.
	 * 
	 * @param obj
	 *            The object being inspected.
	...
	/**
	 * Set the String pattern on the object being inspected if it is not already
	 * set.
	 * 
	 * @param obj
	 *            The object being inspected.
	...
	/**
	 * Set the exportTypes on the object being inspected if it is not already
	 * set.
	 * 
	 * @param obj
	 *            The object being inspected.
	...
	/**
	 * Set the maxRowsIncrements on the object being inspected if it is not
	 * already set.
	 * 
	 * @param obj
	 *            The object being inspected.
	...
	/**
	 * Set the filterMatcherRegistry on the object being inspected if it is not
	 * already set.
	 * 
	 * @param obj
	 *            The object being inspected.
