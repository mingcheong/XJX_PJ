 ...
 * the License.
 */
package com.safetys.framework.jmesa.facade.tag;
...
class TagUtils {
	...
	static HtmlCellRenderer getColumnCellRenderer(HtmlColumn column, String cellRenderer) {
		...
		result.setCellEditor(column.getCellRenderer().getCellEditor()); // reset
																		// the
																		// default
	...
	static HtmlFilterRenderer getColumnFilterRenderer(HtmlColumn column, String filterRenderer) {
		...
		result.setFilterEditor(column.getFilterRenderer().getFilterEditor()); // reset
																			  // the
																			  // default
	...
	static FilterEditor getColumnFilterEditor(HtmlColumn column, String filterEditor) {
		if (StringUtils.isEmpty(filterEditor)) { return column.getFilterRenderer().getFilterEditor(); }
	...
	static HtmlHeaderRenderer getColumnHeaderRenderer(HtmlColumn column, String headerRenderer) {
		...
		result.setHeaderEditor(column.getHeaderRenderer().getHeaderEditor()); // reset
																			  // the
																			  // default
	...
	static HeaderEditor getColumnHeaderEditor(HtmlColumn column, String headerEditor) {
		if (StringUtils.isEmpty(headerEditor)) { return column.getHeaderRenderer().getHeaderEditor(); }
