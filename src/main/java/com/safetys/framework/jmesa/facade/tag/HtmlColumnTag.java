...
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnCellRenderer;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnCellEditor;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnWorksheetEditor;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnFilterRenderer;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnFilterEditor;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnHeaderRenderer;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnHeaderEditor;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getColumnSortOrder;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getWorksheetValidations;
...
public class HtmlColumnTag extends SimpleTagSupport {
	...
	private Object getValue() throws JspException, IOException {
		...
		if (body == null) { return ItemUtils.getItemValue(item, getProperty()); }
