...
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getRowRowRenderer;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getRowOnclick;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getRowOnmouseover;
import static com.safetys.framework.jmesa.facade.tag.TagUtils.getRowOnmouseout;
...
public class HtmlRowTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		if (body == null) { throw new IllegalStateException("You need to wrap the columns in the row tag."); }
