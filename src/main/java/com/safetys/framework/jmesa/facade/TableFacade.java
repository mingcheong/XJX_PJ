...
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateColumnPropertiesIsNotNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateCoreContextIsNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateItemsIsNotNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateItemsIsNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateLimitIsNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateRowSelectIsNotNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateTableIsNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateToolbarIsNull;
import static com.safetys.framework.jmesa.facade.TableFacadeExceptions.validateViewIsNull;
import static com.safetys.framework.jmesa.facade.TableFacadeUtils.filterWorksheetItems;
import static com.safetys.framework.jmesa.facade.TableFacadeUtils.isClearingWorksheet;
import static com.safetys.framework.jmesa.limit.LimitConstants.LIMIT_ROWSELECT_MAXROWS;
...
import com.safetys.framework.jmesa.core.CoreContextFactory;
...
import com.safetys.framework.jmesa.core.preference.PreferencesFactory;
...
import com.safetys.framework.jmesa.view.ExportTableFactory;
import com.safetys.framework.jmesa.view.TableFactory;
import com.safetys.framework.jmesa.view.View;
import com.safetys.framework.jmesa.view.component.Table;
import com.safetys.framework.jmesa.view.csv.CsvTableFactory;
import com.safetys.framework.jmesa.view.csv.CsvView;
import com.safetys.framework.jmesa.view.csv.CsvViewExporter;
import com.safetys.framework.jmesa.view.excel.ExcelView;
import com.safetys.framework.jmesa.view.excel.ExcelViewExporter;
import com.safetys.framework.jmesa.view.html.HtmlConstants;
import com.safetys.framework.jmesa.view.html.HtmlTableFactory;
import com.safetys.framework.jmesa.view.html.HtmlView;
import com.safetys.framework.jmesa.view.html.toolbar.HtmlToolbar;
import com.safetys.framework.jmesa.view.html.toolbar.Toolbar;
import com.safetys.framework.jmesa.view.jexcel.JExcelView;
import com.safetys.framework.jmesa.view.jexcel.JExcelViewExporter;
import com.safetys.framework.jmesa.view.pdf.PdfView;
import com.safetys.framework.jmesa.view.pdf.PdfViewExporter;
import com.safetys.framework.jmesa.view.pdfp.PdfPView;
import com.safetys.framework.jmesa.view.pdfp.PdfPViewExporter;
import com.safetys.framework.jmesa.web.HttpServletRequestWebContext;
import com.safetys.framework.jmesa.web.WebContext;
import com.safetys.framework.jmesa.worksheet.UniqueProperty;
import com.safetys.framework.jmesa.worksheet.Worksheet;
import com.safetys.framework.jmesa.worksheet.WorksheetRow;
import com.safetys.framework.jmesa.worksheet.WorksheetRowStatus;
...
public class TableFacade {
	...
	public Worksheet getWorksheet() {
		if (worksheet != null || !editable) { return worksheet; }
	...
	private WorksheetState getWorksheetState() {
		if (worksheetState == null) { return new SessionWorksheetState(id, getWebContext()); }
	...
	public Limit getLimit() {
		...
		if (items == null) { return limit; }

		/*
		 * We will have a RowSelect if the State returned a Limit. However, we
		 * will still need to re-populate the Limit's RowSelect based on what
		 * the current items total rowcount is.
		 * 
	...
	public void addFilterMatcherMap(FilterMatcherMap filterMatcherMap) {
		...
		if (filterMatcherMap == null) { return; }
	...
	public CoreContext getCoreContext() {
		if (coreContext != null) { return coreContext; }
	...
	protected Table getExportTable(ExportType exportType) {
		...
		if (tableFactory != null) { return tableFactory.createTable(columnProperties); }
	...
	public String render() {
		Limit l = getLimit();
		View v = getView();
		if (!l.isExported()) { return v.render().toString(); }
	...
	protected void renderExport(ExportType exportType, View view) {
		if (response == null) { throw new IllegalStateException("The HttpServletResponse is null. You need to call the "
