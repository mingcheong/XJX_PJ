 ...
 */
package com.safetys.framework.jmesa.core.message;
...
public class ResourceBundleMessages implements Messages {
    private static final long serialVersionUID = 1641605764395083288L;

	private Logger logger = LoggerFactory.getLogger(ResourceBundleMessages.class);

    private static final String JMESA_RESOURCE_BUNDLE = "com/safetys/framework/jmesa/core/message/resource/jmesaResourceBundle";
