 ...
 * the License.
 */
package com.safetys.framework.jmesa.core.preference;
...
public final class PropertiesPreferences implements Preferences {
	private static final long serialVersionUID = 756009005809770020L;
	...
	private InputStream getInputStream(String preferencesLocation, WebContext webContext) throws IOException {
