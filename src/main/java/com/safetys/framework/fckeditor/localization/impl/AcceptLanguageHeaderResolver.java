 ...
 */
package com.safetys.framework.fckeditor.localization.impl;
...
import com.safetys.framework.fckeditor.localization.LocaleResolver;
import com.safetys.framework.fckeditor.tool.Utils;

/**
 * HTTP header implementation of the locale resolver. It resolves the current user locale by calling {@link ServletRequest#getLocale()} if and only if the <code>Accept-Language</code> header is not
 * empty.
 * 
 * @version $Id: AcceptLanguageHeaderResolver.java 4785 2009-12-21 20:10:28Z mosipov $
 */
