...
import com.safetys.framework.fckeditor.requestcycle.impl.ServerRootPathBuilder;
 ...
 * <ul>
 * <li>from a static context of a servlet container/application server,</li>
 * <li>from virtual servers with Apache HTTPd on different domains, e.g. <code>http://userfiles.mydomain.com</code>, or</li>
 * <li>on a per-user basis, e.g. uploading to <code>/home/$USERNAME/public_html/fckeditor</code> and an Apache HTTPd serves as <code>/~$USERNAME/fckeditor</code>.</li>
 * </ul>
 * </p>
 * Use the {@link ServerRootPathBuilder} in conjunction with this class.
 * 
 * @version $Id: LocalConnector.java 4785 2009-12-21 20:10:28Z mosipov $
 */
