...
/**
 * UserPathBuilder implementation which always returns static userfiles paths with prepended context path. In particular it returns the {@code connector.userFiles*Path} properties and prepend the
 * current context path to {@link #getUserFilesPath(HttpServletRequest)} only.
 * 
 * @version $Id: ContextPathBuilder.java 4785 2009-12-21 20:10:28Z mosipov $
 */
