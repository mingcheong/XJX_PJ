...
/**
 * An interface for userfiles path construction. In particular, this interface gives you the ability to construct the {@code connector.userFilesPath} and {@code connector.userFilesAbsolutePath}
 * properties dynamically. See <a href="http://java.fckeditor.net/properties.html">configuration</a> for more details.
 * <p>
...
public interface UserPathBuilder {
	...
	/**
	 * Returns the constructed server-side userfiles absolute path. This method is the dynamic constructor of the {@code connector.userFilesAbsolutePath} property. A concrete connector implementation
	 * will use this value to resolve the server-side location of resources.
	 * 
	 * @param request
	...
	/**
	 * Returns the constructed client-side userfiles path. This method is the dynamic constructor of the {@code connector.userFilesPath} property. A browser will use this value to resolve the url-side
