...
/**
 * Maintains current {@link Context context} and {@link HttpServletRequest request} instances. This container relies on {@link ThreadLocal} and provides static access to the aforementioned objects for
 * the current File Browse request. This means that this class is thread-safe.
 * 
 * @version $Id: ThreadLocalData.java 4785 2009-12-21 20:10:28Z mosipov $
 */
public class ThreadLocalData {
	...
	public static HttpServletRequest getRequest() {
		return ThreadLocalData.request.get();
	}
	...
	public static Context getContext() {
		return ThreadLocalData.context.get();
	}
	...
	public static void endRequest() {
		...
		ThreadLocalData.request.set(null);
		ThreadLocalData.context.set(null);
	}
}
