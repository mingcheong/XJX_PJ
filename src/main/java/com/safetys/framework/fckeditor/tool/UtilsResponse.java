...
public class UtilsResponse {
	 ...
	 */
	public static String getUrl(String userFilesPath, ResourceType type, String currentFolder) {
		return UtilsResponse.fileUrl(userFilesPath, type, currentFolder, null);
	}
	 ...
	 */
	public static String fileUrl(String userFilesPath, ResourceType type, String currentFolder, String filename) {
