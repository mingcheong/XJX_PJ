 ...
 * @since 1.0
 */
@Repository("jxDeptDao")
public class JxDeptDaoImpl extends BaseDaoImpl<JxDeptModel, Long> implements IJxDeptDao {

	public JxDeptDaoImpl() {
		super(JxDeptModel.class, "jxDeptModel");
	}
}
