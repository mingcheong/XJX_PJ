 ...
 * @since 1.0
 */
@Repository("jxGoodsDao")
public class JxGoodsDaoImpl extends BaseDaoImpl<JxGoodsModel, Long> implements IJxGoodsDao {

	public JxGoodsDaoImpl() {
		super(JxGoodsModel.class, "jxGoodsModel");
	}
}
