...
(function($) {
  ...
  $.fn.jOrgChart = function(options) {
    ...
    return this.each(function() {
      $this = $(this);
      var $container = $("<div id='chart' class='" + opts.chartClass + "' style='margin:0 auto;'/>");
      if($this.is("ul")) {
        buildNode($this.find("li:first"), $container, 0, opts,"level_1");
      }
      else if($this.is("li")) {
  ...
  function buildNode($node, $appendTo, level, opts,index) {
	...
	if(index == "level_1")
		$nodeDiv = $("<div>").addClass("nodeLevel_1").append($nodeContent);
	// Expand and contract nodes  鼠标点击结点事件
