...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="topgzq" height="28" align="center">
    <tr>
    	<td align="center" ><div class="dqwz">您现在的位置：区域管理</div></td>
    </tr>
</table>
<TABLE border=0 width="100%" height="100%"  align=left>
	<TR>
		<TD width="213px" align="left" valign="top" style="border-right: #000000 1px dashed">
			<@fkMacros.simpleTree 'enumframe','${treeNodes}','fkArea_ajax.xhtml' />
		</TD>
		<TD align=left valign=top>
			<IFRAME id="enumframe" Name="enumframe" url="fkArea_manager.xhtml?fkAreaModel.fatherId=" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=100% src="fkArea_manager.xhtml"></IFRAME>
		</TD>
	</TR>
</TABLE>
<@fkMacros.pageFooter />