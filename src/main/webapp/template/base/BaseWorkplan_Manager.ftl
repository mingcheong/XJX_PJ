...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="topgzq" height="28" align="center">
    <tr>
    	<td align="center" ><div class="dqwz">您现在的位置：工作计划管理</div></td>
    </tr>
</table>
<@s.form id="baseWorkplanForm" action="baseWorkplan_manager.xhtml"><@s.token />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_menu" height="30" align="center">
  <tr>
	...
	<div >
	  <div class="menu_left">
		<ul>
			<@util.menu_add '添 加'> obj="baseWorkplan" </@util.menu_add>
			<@util.menu_edit '编 辑'> obj="baseWorkplan" </@util.menu_edit>
			<@util.menu_delAll '删 除'> obj="baseWorkplan" </@util.menu_delAll>
	...
	<@jmesa.htmlTable width="100%" style="text-align:left;">
		<@jmesa.htmlRow>
				<@jmesa.htmlColumn property="id" style="text-align: center;" width="3%" title="<input type='checkbox' id='checkAll' name='checkAll'/>" filterable=false sortable=false>
					<input type="checkbox" name="selectedIds" value="${baseWorkplan.id}" />
				</@jmesa.htmlColumn>
