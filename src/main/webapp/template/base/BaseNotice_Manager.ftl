...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="topgzq" height="28" align="center">
    <tr>
    	<td align="center" ><div class="dqwz">您现在的位置：通知公告管理</div></td>
    </tr>
</table>
<@s.form id="baseNoticeForm" action="baseNotice_manager.xhtml"><@s.token />
	...
	<@jmesa.htmlTable width="100%" style="text-align:left;">
		<@jmesa.htmlRow>
				<@jmesa.htmlColumn property="id" style="text-align: center;" width="3%" title="<input type='checkbox' id='checkAll' name='checkAll'/>" filterable=false sortable=false>
					<input type="checkbox" name="selectedIds" value="${baseNotice.id}" />
				</@jmesa.htmlColumn>
				<@jmesa.htmlColumn property="name" title="标题" ><a href="${contextPath}/baseNotice_detail.xhtml?id=${baseNotice.id}">${baseNotice.name}</a></@jmesa.htmlColumn>
