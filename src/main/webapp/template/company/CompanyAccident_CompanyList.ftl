...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="topgzq" height="28" align="center">
    <tr>
    	<td align="center" ><div class="dqwz">您现在的位置：事故管理->企业列表</div></td>
    </tr>
</table>
<@s.form id="companyInfoForm" action="companyAccident_companyList.xhtml"><@s.token />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_menu" height="30" align="center">
  <tr>
	...
	<div >
	  <div class="menu_left">
		<ul>
			<@util.company_add '添加事故信息'> obj="companyAccident_managerList.xhtml"  </@util.company_add>
			<!--<@util.company_edit '编辑事故信息'> obj="companyAccident_managerList.xhtml" </@util.company_edit>-->
