...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="topgzq" height="28" align="center">
    <tr>
    	<td align="center" ><div class="dqwz">您现在的位置：行政许可->企业列表</div></td>
    </tr>
</table>
<@s.form id="companyInfoForm" action="companyLicensing_companyList.xhtml"><@s.token />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_menu" height="30" align="center">
  <tr>
	...
	<div >
	  <div class="menu_left">
		<ul>
			<@util.company_add '添加许可证'> obj="companyLicensing_managerList.xhtml"  </@util.company_add>
			<!--<@util.company_edit '编辑许可证'> obj="companyLicensing_managerList.xhtml" </@util.company_edit>-->
...
<@jmesa.tableModel items=companyInfoModels  limit=companyInfoModel.limit filterMatcherMap="com.safetys.framework.filter.TagFilterMatcherMap" stateAttr="restore"
	...
	<@jmesa.htmlTable width="100%" style="text-align:left;">
		<@jmesa.htmlRow>
				...
				<@jmesa.htmlColumn property="companyName" title="单位名称" />
				<@jmesa.htmlColumn property="address" title="地址" />
				<@jmesa.htmlColumn property="area" title="区域">
					<@enum.getSelectArea '${companyInfo.firstArea}'/>
					&nbsp;
					<@enum.getSelectArea '${companyInfo.secondArea}'/>
					&nbsp;
					<@enum.getSelectArea '${companyInfo.thirdArea}'/>
				</@jmesa.htmlColumn>
