...
<@s.form id="companyHiddendangerForm" action="companyHiddendanger_hiddenListingManager.xhtml"><@s.token />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_menu" height="30" align="center">
  <tr>
	...
	<div >
	  <div class="menu_left">
		<ul>
			<@util.company_add '挂牌'> obj="companyHiddendanger_hiddenListing.xhtml" </@util.company_add>
...
<@jmesa.tableModel items=companyHiddendangerModels limit=companyHiddendangerModel.limit filterMatcherMap="com.safetys.framework.filter.TagFilterMatcherMap" stateAttr="restore"
	...
	<@jmesa.htmlTable width="100%" style="text-align:left;">
		<@jmesa.htmlRow>
				...
				<@jmesa.htmlColumn property="companyInfoModel.companyName" title="单位名称" ><a href="${contextPath}/companyHiddendanger_hiddenListingDetail.xhtml?id=${companyHiddendanger.id}">${companyHiddendanger.companyInfoModel.companyName}</a></@jmesa.htmlColumn>
