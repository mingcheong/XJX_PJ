...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="topgzq" height="28" align="center">
    <tr>
    	<td align="center" ><div class="dqwz">您现在的位置：行政执法录入企业列表</div></td>
    </tr>
</table>
<@s.form id="companyInfoForm" action="companyInspect_companyInfoManager.xhtml"><@s.token />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_menu" height="30" align="center">
  <tr>
	...
	<div >
	  <div class="menu_left">
		<ul>
			<@util.company_add '现场检查记录'> obj="companyInspect_inspectManager.xhtml" </@util.company_add>
...
<@jmesa.tableModel items=companyInfoModels  limit=companyInfoModel.limit filterMatcherMap="com.safetys.framework.filter.TagFilterMatcherMap" stateAttr="restore"
	...
	<@jmesa.htmlTable width="100%" style="text-align:left;">
		<@jmesa.htmlRow>
				...
				<@jmesa.htmlColumn property="companyName" title="企业名称" ><a href="${contextPath}/companyInfo_detail.xhtml?id=${companyInfo.id}">${companyInfo.companyName}</a></@jmesa.htmlColumn>
