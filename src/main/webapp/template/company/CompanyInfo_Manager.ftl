...
<@s.form id="companyInfoForm" action="companyInfo_manager.xhtml"><@s.token />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_menu" height="30" align="center">
  <tr>
	...
	<div >
	  <div class="menu_left">
		<ul>
			<@util.menu_add '添 加'> obj="companyInfo" </@util.menu_add>
			<@util.menu_edit '编 辑'> obj="companyInfo" </@util.menu_edit>
			<@util.menu_delAll '删 除'> obj="companyInfo" </@util.menu_delAll>
...
<@enum.selectAreas "companyInfoModel","div-area","${companyInfoModel?if_exists.firstArea?if_exists}","${companyInfoModel?if_exists.secondArea?if_exists}","${companyInfoModel?if_exists.thirdArea?if_exists}","${companyInfoModel?if_exists.fouthArea?if_exists}","${companyInfoModel?if_exists.fifthArea?if_exists}" /> 
<@fkMacros.pageFooter />
